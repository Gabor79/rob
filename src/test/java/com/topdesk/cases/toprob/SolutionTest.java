...
public class SolutionTest {
    ...
    public void whenNoPathToKitchen() {
        System.out.println(Instruction.EAST.execute(new Coordinate(1,1)));
    ...
    @Test
    public void whenOneDimensional1() {
        Grid grid = GridFactory.create(
                "rABk");
    ...
    @Test
    public void whenOneDimensional2() {
        Grid grid = GridFactory.create(
                "rABCDEFGk");
